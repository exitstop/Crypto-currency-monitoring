...
func main() {
  ...
  //  }(monitor)
	...
	monitor.AddCoin(lCommon.ListMonitor{Coin: "BTCUSDT", Exchange: "binance", Price: 0.02, UpPerPercent: 0.02, DownPerPercent: 0, UpPer: 0, DownPer: 0, UpLine: 0, DownLine: 0, Hodl: 0.15124802, HodlUsd: -1, CallBack: lCn.GetPriceBinance})
  monitor.AddCoin(lCommon.ListMonitor{Coin: "ETHUSDT", Exchange: "binance", Price: 0, UpPerPercent: 0, DownPerPercent: 0, UpPer: 0, DownPer: 0, UpLine: 0, DownLine: 0, Hodl: 0, CallBack: lCn.GetPriceBinance})
	...
	monitor.AddCoin(lCommon.ListMonitor{Coin: "TRXBTC", Exchange: "binance", Price: 0.06, UpPerPercent: 0.06, DownPerPercent: 0, UpPer: 0, DownPer: 0, UpLine: 0, DownLine: 0, Hodl: 0, CallBack: lCn.GetPriceBinance})
  ...
  monitor.AddCoin(lCommon.ListMonitor{Coin: "WAVESBTC", Exchange: "binance", Price: 0.06, UpPerPercent: 0.06, DownPerPercent: 0, UpPer: 0, DownPer: 0, UpLine: 0, DownLine: 0, Hodl: 0, CallBack: lCn.GetPriceBinance})
  monitor.AddCoin(lCommon.ListMonitor{Coin: "CDTBTC", Exchange: "binance", Price: 0.06, UpPerPercent: 0.06, DownPerPercent: 0, UpPer: 0, DownPer: 0, UpLine: 0, DownLine: 0, Hodl: 0, CallBack: lCn.GetPriceBinance})
  monitor.AddCoin(lCommon.ListMonitor{Coin: "XLMBTC", Exchange: "binance", Price: 0.06, UpPerPercent: 0.06, DownPerPercent: 0, UpPer: 0, DownPer: 0, UpLine: 0, DownLine: 0, Hodl: 0, CallBack: lCn.GetPriceBinance})
  monitor.AddCoin(lCommon.ListMonitor{Coin: "BQXBTC", Exchange: "binance", Price: 0.06, UpPerPercent: 0.06, DownPerPercent: 0, UpPer: 0, DownPer: 0, UpLine: 0, DownLine: 0, Hodl: 0, CallBack: lCn.GetPriceBinance})
 ...
 //  monitor.AddCoin(lCommon.ListMonitor{Coin: "BTC-XEM", Exchange: "bittrex", Price: 0, UpPerPercent: 0, DownPerPercent: 0, UpPer: 0, DownPer: 0, UpLine: 0, DownLine: 0, Hodl: 0, CallBack: lCn.GetPriceBittrex})
	...
	monitor.AddCoin(lCommon.ListMonitor{Coin: "OCN-BTC", Exchange: "kucoin", Price: 0, UpPerPercent: 0.05, DownPerPercent: 0.04, UpPer: 0, DownPer: 0, UpLine: 0, DownLine: 0, Hodl: 85764.18, CallBack: lCn.GetPriceKucoin})
  ...
  monitor.AddCoin(lCommon.ListMonitor{Coin: "TKY-BTC", Exchange: "kucoin", Price: 0, UpPerPercent: 0.06, DownPerPercent: 0.06, UpPer: 0, DownPer: 0, UpLine: 0, DownLine: 0, Hodl: 68340, CallBack: lCn.GetPriceKucoin})
