...
func main() {
  ...
  monitor.AddCoin(lCommon.ListMonitor{Coin: "BTCUSDT", Exchange: "binance", Price: 0, UpPerPercent: 0.001, DownPerPercent: 0.001, UpPer: 0, DownPer: 0, UpLine: 0, DownLine: 0, Hodl: 0.15124802, HodlUsd: -1})
  monitor.AddCoin(lCommon.ListMonitor{Coin: "ETHUSDT", Exchange: "binance", Price: 0, UpPerPercent: 0.003, DownPerPercent: 0.003, UpPer: 0, DownPer: 0, UpLine: 0, DownLine: 0, Hodl: 0})
  monitor.AddCoin(lCommon.ListMonitor{Coin: "ETCBTC", Exchange: "binance", Price: 0, UpPerPercent: 0.003, DownPerPercent: 0.003, UpPer: 0, DownPer: 0, UpLine: 0, DownLine: 0, Hodl: 0})
  monitor.AddCoin(lCommon.ListMonitor{Coin: "LTCUSDT", Exchange: "binance", Price: 0, UpPerPercent: 0.003, DownPerPercent: 0.003, UpPer: 0, DownPer: 0, UpLine: 0, DownLine: 0, Hodl: 0})
  monitor.AddCoin(lCommon.ListMonitor{Coin: "NEOUSDT", Exchange: "binance", Price: 0, UpPerPercent: 0.003, DownPerPercent: 0.003, UpPer: 0, DownPer: 0, UpLine: 0, DownLine: 0, Hodl: 0})
  monitor.AddCoin(lCommon.ListMonitor{Coin: "XRPBTC", Exchange: "binance", Price: 0, UpPerPercent: 0.003, DownPerPercent: 0.003, UpPer: 0, DownPer: 0, UpLine: 0, DownLine: 0, Hodl: 0})
  monitor.AddCoin(lCommon.ListMonitor{Coin: "XMRBTC", Exchange: "binance", Price: 0, UpPerPercent: 0.003, DownPerPercent: 0.003, UpPer: 0, DownPer: 0, UpLine: 0, DownLine: 0, Hodl: 0})
  ...
  monitor.AddCoin(lCommon.ListMonitor{Coin: "NCASHBTC", Exchange: "binance", Price: 0,UpPerPercent: 0.13, DownPerPercent: 0.13, UpPer: 0, DownPer: 0, UpLine: 0, DownLine: 0, Hodl: 0})
