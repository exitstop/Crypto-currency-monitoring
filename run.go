...
func main() {
  ...
  monitor.AddCoin(lCommon.ListMonitor{Coin: "BTC-XEM", Exchange: "bittrex", Price: 0, UpPerPercent: 0, DownPerPercent: 0, UpPer: 0, DownPer: 0, UpLine: 0, DownLine: 0, Hodl: 0, CallBack: lCn.GetPriceBittrex})
	...
	monitor.AddCoin(lCommon.ListMonitor{Coin: "OCN-BTC", Exchange: "kucoin", Price: 0, LogSavePrice: 0.00000124, UpPerPercent: 0.05, DownPerPercent: 0.04, UpPer: 0, DownPer: 0, UpLine: 0, DownLine: 0, Hodl: 85764.18, CallBack: lCn.GetPriceKucoin})
